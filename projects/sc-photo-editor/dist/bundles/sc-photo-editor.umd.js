(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('fabric'), require('rxjs'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('sc-photo-editor', ['exports', 'fabric', 'rxjs', '@angular/core'], factory) :
    (factory((global['sc-photo-editor'] = {}),global.fabric,global.rxjs,global.ng.core));
}(this, (function (exports,fabric,rxjs,i0) { 'use strict';
    ...
    var ScPhotoEditorService = /** @class */ (function () {
        ...
        /** @nocollapse */ ScPhotoEditorService.ngInjectableDef = i0.defineInjectable({ factory: function ScPhotoEditorService_Factory() { return new ScPhotoEditorService(); }, token: ScPhotoEditorService, providedIn: "root" });
    ...
    ***************************************************************************** */
    ...
    var ScPhotoEditorComponent = /** @class */ (function () {
        function ScPhotoEditorComponent(helpers) {
            ...
            this._mode$ = new rxjs.ReplaySubject(1);
            this._source$ = new rxjs.ReplaySubject(1);
         ...
         */
            function () {
                var _this = this;
                this.initWorkspace();
                rxjs.combineLatest(this.mode$, this.source$).subscribe(( /**
                 * @param {?} __0
                 * @return {?}
                 */function (_a) {
         ...
         */
            function () {
                this.canvas = new fabric.fabric.Canvas('sc-canvas');
         ...
         */
            function (source) {
                var _this = this;
                fabric.fabric.Image.fromURL(source, ( /**
                 * @param {?} fImg
                 * @return {?}
                 */function (fImg) {
        ...
        /** @nocollapse */
        ScPhotoEditorComponent.ctorParameters = function () {
            return [
                { type: HelpersService }
            ];
        };
        ScPhotoEditorComponent.propDecorators = {
            editorWidth: [{ type: i0.Input }],
            exportWidth: [{ type: i0.Input }],
    ...
    exports.ScPhotoEditorService = ScPhotoEditorService;
    exports.ScPhotoEditorComponent = ScPhotoEditorComponent;
    exports.ScPhotoEditorModule = ScPhotoEditorModule;
    exports.ɵa = HelpersService;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=sc-photo-editor.umd.js.map